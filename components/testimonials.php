<?php
$reviews = $reviews ?? [
  ['name'=>'Maria G.',  'loc'=>'Houston, TX',     'stars'=>5, 'text'=>'I was juggling six credit cards. One call, one form, and I had a clear plan within a week. My monthly payment dropped by over $400.'],
  ['name'=>'Daniel R.', 'loc'=>'Salt Lake City, UT','stars'=>5, 'text'=>'They explained everything in plain English. No high-pressure sales. I finally feel like I have a clear plan to pay everything off.'],
  ['name'=>'Karen H.',  'loc'=>'Austin, TX',       'stars'=>5, 'text'=>'My rate, term, and monthly payment were spelled out up front. The specialist was patient and answered every question.'],
];
?>
