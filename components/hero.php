 ...
 * Vars:
 *   $eyebrow, $headline, $sub, $bullets (array of strings)
 */
$eyebrow  = $eyebrow  ?? 'Debt & loan solutions';
$headline = $headline ?? 'One simple payment.<br>One clear path forward.';
$sub      = $sub      ?? 'See how much you could save by consolidating high-interest credit card debt into a single, lower monthly payment — with no impact to your credit score to check rates.';
$bullets  = $bullets  ?? [
