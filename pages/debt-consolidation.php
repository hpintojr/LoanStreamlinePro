...
component('hero', [
  ...
  'bullets'  => [
    'Best for $5,000 – $100,000 of credit card debt',
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      $benefits = [
        ...
        ['t'=>'A clear payoff date', 'd'=>'Unlike revolving credit card minimums, an installment loan has a defined term — so you know exactly when you\'ll be debt-free.', 'icon'=>'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
      ];
...
<section class="py-16 bg-soft-gradient">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <p class="mt-4 text-slate-600 max-w-3xl mx-auto">When you submit your information, we compare programs from our trusted lending and debt-relief partners and present the options that fit your profile. You'll see rates, terms, monthly payments, and fees side-by-side. There is no obligation to accept any offer, and pre-qualification uses only a soft credit pull.</p>
