...
<section class="py-16 bg-white">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    $detailedSteps = [
      [
        'n'   => '01',
        't'   => 'Tell us about your debt',
        'd'   => 'Use our 60-second form to share a few details: how much debt you have, your goal (lower payments, payoff faster, etc.), and your estimated credit range.',
